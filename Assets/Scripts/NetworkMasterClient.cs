...
public class NetworkMasterClient : MonoBehaviour
{
    ...
    public void InitializeClient()
    {
        ...
        Debug.Log("connecting " + MasterServerIpAddress + ":" + MasterServerPort.ToString());
        ...
        client.RegisterHandler(MasterMsgTypes.GuessedId, OnGuessed);
    ...
    void OnGuessed(NetworkMessage netMsg)
    {
    ...
    {		
        ...
        client.Send(MasterMsgTypes.GuessId, msg);
